...
export class OrbitThreeVisualEngine{
  constructor(canvas,{width=960,height=540,scale=1.5}={}){
    ...
    this.pools={enemies:[],enemySilhouettes:[],enemyWakes:[],enemyGlows:[],enemyRings:[],enemyMarkers:[],allies:[],allyTrails:[],bulletSilhouettes:[],bullets:[],hostileBulletOutlines:[],hostileBullets:[],loot:[],particles:[],muzzles:[],rings:[],beams:[],bars:[],echoes:[],orbitals:[],mines:[],floaters:[],deathGlows:[],deathRings:[]};
  ...
  syncProjectiles(state,settings){
    ...
    this.use(this.pools.bulletSilhouettes,state.bullets.length,()=>this.sprite(this.textures.projectile),(silhouette,i)=>{const body=this.pools.bullets[i];this.placeSprite(silhouette,body.position.x,body.position.y,body.scale.x+5,body.scale.y+4,-body.material.rotation,6,.84,'#020405')});
