...
export class OrbitThreeVisualEngine{
  ...
  syncMenu(settings){
    ...
    this.playerTrail.visible=this.playerAttitudeLeft.visible=this.playerAttitudeRight.visible=false;this.playerEngineLeft.visible=this.playerEngineRight.visible=true;this.placeSprite(this.playerEngineLeft,x-5,y+48,7,38,Math.PI/2,2,.36+.11*pulse,combatPalette.friendly);this.placeSprite(this.playerEngineRight,x+5,y+48,7,36,Math.PI/2,2,.34+.10*(1-pulse),combatPalette.friendlySoft);
