...
export class OrbitThreeVisualEngine{
  constructor(canvas,{width=960,height=540,scale=1.5}={}){
    ...
    this.playerGlow=this.sprite(this.glowTexture,THREE.AdditiveBlending);this.playerTrail=this.sprite(this.engineTexture,THREE.AdditiveBlending);this.playerEngineLeft=this.sprite(this.engineTexture,THREE.AdditiveBlending);this.playerEngineRight=this.sprite(this.engineTexture,THREE.AdditiveBlending);this.playerRim=this.sprite(this.textures.player,THREE.AdditiveBlending);this.player=this.sprite(this.textures.player);this.world.add(this.playerTrail,this.playerEngineLeft,this.playerEngineRight,this.playerGlow,this.playerRim,this.player);
  ...
  syncMenu(settings){
    ...
    this.player.visible=this.playerRim.visible=true;this.playerGlow.visible=settings.glow!=='OFF';this.placeSprite(this.playerRim,x,y,59,88,yaw,4,.18,'#80d5c6');this.placeSprite(this.player,x,y,56,84,yaw,5,1,'#eef2eb');this.placeSprite(this.playerGlow,x,y,122,122,0,3,.18*pulse,'#c3b26d');
    this.playerTrail.visible=false;this.playerEngineLeft.visible=this.playerEngineRight.visible=true;this.placeSprite(this.playerEngineLeft,x-5,y+48,7,38,Math.PI/2,2,.36+.11*pulse,'#8ff4dc');this.placeSprite(this.playerEngineRight,x+5,y+48,7,36,Math.PI/2,2,.34+.10*(1-pulse),'#ffd17b');
