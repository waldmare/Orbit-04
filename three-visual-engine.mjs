...
const enemyAccent={scout:'#ff5c7f',charger:'#ff8a3d',tank:'#ffd059',gunner:'#ff3f91',splitter:'#b8f05a',sniper:'#bd8cff',boss:'#ff244f'};
const enemyBodyTint={scout:'#efa5b4',charger:'#f7bb80',tank:'#dfcf84',gunner:'#ec90ae',splitter:'#b8d98a',sniper:'#c7afe7',boss:'#f48aa0'};
