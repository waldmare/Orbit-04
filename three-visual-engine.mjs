...
export class OrbitThreeVisualEngine{
  constructor(canvas,{width=960,height=540,scale=1.5}={}){
    ...
    this.pools={enemies:[],enemyWakes:[],enemyGlows:[],enemyRings:[],enemyMarkers:[],allies:[],allyTrails:[],bullets:[],hostileBulletOutlines:[],hostileBullets:[],loot:[],particles:[],muzzles:[],rings:[],beams:[],bars:[],echoes:[],orbitals:[],mines:[],floaters:[],deathGlows:[],deathRings:[]};
