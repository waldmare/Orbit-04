...
const enemyAccent={scout:'#ff4d86',charger:'#ff684c',tank:'#d79d49',gunner:'#ff2d82',splitter:'#d64b79',sniper:'#a879ff',stalker:'#ed48c9',weaver:'#7f89ff',warden:'#55d1ae',boss:'#ff214f'};
const enemyBodyTint={scout:'#e889a4',charger:'#e99172',tank:'#c5a66c',gunner:'#e378a0',splitter:'#c77a98',sniper:'#b79add',stalker:'#dc78ca',weaver:'#9ca3e8',warden:'#7fc6b1',boss:'#f07891'};
...
const markedEnemyTypes=new Set(['charger','tank','gunner','splitter','sniper','stalker','weaver','warden']);
...
export class OrbitThreeVisualEngine{
  ...
  syncEnemies(state,settings,glow){
    ...
    const marked=enemies.map((enemy,index)=>({enemy,index})).filter(({enemy})=>enemy.boss||enemy.elite||enemy.nemesis||enemy.bounty||clarity==='HIGH'&&markedEnemyTypes.has(enemy.type)||clarity==='BALANCED'&&['charger','gunner','sniper'].includes(enemy.type)),ringBoost=clarity==='HIGH'?1.25:clarity==='BALANCED'?1.10:1;
